...
export default {
  ...
  flags: {
    ...
    enableRightClickMenus: true,
    enableQuickActionMenus: true,
    enableStickers: true,
    enableExperimentalAnimationEffects: true,
    showTextAndShapesSearchInput: true,
    showElementsTab: true,
    incrementalSearchDebounceMedia: true,
  },
  publicPath: `${url}`,
};
